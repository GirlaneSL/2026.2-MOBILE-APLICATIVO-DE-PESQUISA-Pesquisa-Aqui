...
export type StorageHash =
  StorageHashBase<'a7d28695f19fb0e88f7146b5beb72a02821c3f35357e567d1fb6f2caaafdd312'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly ResearchDownload: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly researchId: CodecTypes['pg/int4@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly ResearchDownload: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly researchId: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly question: {
              ...
              indexes: readonly [
                {
                  readonly name: 'question_sectionId_idx_5d1ea56b';
                  readonly prefix: 'question_sectionId_idx';
            ...
            readonly researchDownload: {
              ...
              indexes: readonly [
                {
                  readonly name: 'researchDownload_researchId_idx_36f1b4c8';
                  readonly prefix: 'researchDownload_researchId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'researchDownload';
                    readonly columns: readonly ['researchId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly section: {
              ...
              indexes: readonly [
                {
                  readonly name: 'section_researchId_idx_36f1b4c8';
                  readonly prefix: 'section_researchId_idx';
                  readonly columns: readonly ['researchId'];
                  readonly unique: false;
                },
              ];
...
> & {
  ...
  readonly roots: {
    ...
    readonly researchDownload: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'ResearchDownload';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          ...
          readonly Question: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly helpText: { readonly column: 'helpText' };
          ...
          readonly ResearchDownload: {
            ...
            readonly storage: {
              readonly table: 'researchDownload';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
